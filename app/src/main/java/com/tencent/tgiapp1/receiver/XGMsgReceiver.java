package com.tencent.tgiapp1.receiver;
...
public class XGMsgReceiver extends XGPushBaseReceiver {
    ...
    public static final String LogTag = XGMsgReceiver.class.getName();
    ...
    public void onNotifactionShowedResult(Context context,
        ...
        Intent intent = new Intent(context.getString(R.string.receiver_xgnotice));
