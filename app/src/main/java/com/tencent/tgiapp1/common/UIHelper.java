...
import com.tencent.tgiapp1.activity.XGNoticeActivity;
import com.tencent.tgiapp1.activity.XGNoticeDetailActivity;
import com.tencent.tgiapp1.adapter.GridViewFaceAdapter;
...
import com.tencent.tgiapp1.widget.LinkView.MyURLSpan;
import com.tencent.tgiapp1.widget.PathChooseDialog.ChooseCompleteListener;
import com.tencent.tgiapp1.widget.ScreenShotView;
import com.tencent.tgiapp1.widget.ScreenShotView.OnScreenShotListener;
...
public class UIHelper {
    ...
    public static void showNewsDetailByInstance(Context context, News news,String title,boolean hideFootbar) {
        showNewsDetailByInstance(context,news,title,hideFootbar,true);
    }
     ...
     * @param news
     */
    public static void showNewsDetailByInstance(Context context, News news,String title,boolean hideFootbar,boolean allowFullscreen) {
        Intent intent = new Intent(context, NewsDetail.class);
        ...
        bundle.putBoolean("allowFullscreen",allowFullscreen);
