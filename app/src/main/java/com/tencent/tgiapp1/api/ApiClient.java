package com.tencent.tgiapp1.api;
...
import com.tencent.tgiapp1.bean.ActiveList;
import com.tencent.tgiapp1.bean.Barcode;
import com.tencent.tgiapp1.bean.Blog;
import com.tencent.tgiapp1.bean.BlogCommentList;
import com.tencent.tgiapp1.bean.BlogList;
import com.tencent.tgiapp1.bean.CommentList;
import com.tencent.tgiapp1.bean.FavoriteList;
import com.tencent.tgiapp1.bean.FriendList;
import com.tencent.tgiapp1.bean.MessageList;
import com.tencent.tgiapp1.bean.MyInformation;
import com.tencent.tgiapp1.bean.News;
import com.tencent.tgiapp1.bean.NewsList;
import com.tencent.tgiapp1.bean.Notice;
import com.tencent.tgiapp1.bean.Post;
import com.tencent.tgiapp1.bean.PostList;
import com.tencent.tgiapp1.bean.Report;
import com.tencent.tgiapp1.bean.Result;
import com.tencent.tgiapp1.bean.SearchList;
import com.tencent.tgiapp1.bean.Software;
import com.tencent.tgiapp1.bean.SoftwareCatalogList;
import com.tencent.tgiapp1.bean.SoftwareList;
import com.tencent.tgiapp1.bean.Tweet;
import com.tencent.tgiapp1.bean.TweetList;
import com.tencent.tgiapp1.bean.URLs;
import com.tencent.tgiapp1.bean.Update;
import com.tencent.tgiapp1.bean.User;
import com.tencent.tgiapp1.bean.UserInformation;
import com.tencent.tgiapp1.bean.WellcomeImage;
...
public class ApiClient {
    ...
    private static String getUserAgent(AppContext appContext) {
        if(appUserAgent == null || appUserAgent == "") {
            StringBuilder ua = new StringBuilder(appContext.getString(R.string.app_id));
    ...
    private static HttpGet getHttpGet(String url, String cookie, String userAgent) {
        return HttpUtil.getHttpGet(url,null,cookie,userAgent);
    }

    private static HttpPost getHttpPost(String url, String cookie, String userAgent) throws Exception{
        return HttpUtil.getHttpPost(url,null,cookie,userAgent);
    }
    ...
    private static InputStream http_get(AppContext appContext, String url) throws AppException {
        ...
        do{
            try
            {
                responseBody = HttpUtil.get(url,null,cookie,userAgent);
                break;
            } catch (Exception e) {
                time++;
                if(time < RETRY_TIME) {
     ...
     * @throws AppException
     */
    private static InputStream _post(AppContext appContext, String url, HashMap<String, String> params) throws AppException {
        ...
        String responseBody = "";
        int time = 0;
        final AppContext appContext1 = appContext;

        final Handler cookieHandler = new Handler(){
            @Override
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                Header[] headers = (Header[])msg.obj;
                String tmpcookies = "";
                for (Header h : headers) {
                    tmpcookies += h.getValue().toString()+";";

                    //保存cookie
                    if(appContext1 != null && tmpcookies != ""){
                        appContext1.setProperty("cookie", tmpcookies);
        ...
        do{
            try
            {
                ...
                responseBody = HttpUtil.post(url,params,cookie,userAgent,cookieHandler);
    ...
    public static User login(AppContext appContext, String username, String pwd) throws AppException {
        ...
        try{
            return User.parse(_post(appContext, loginurl, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static MyInformation myInformation(AppContext appContext, long uid) throws AppException {
        ...
        try{
            return MyInformation.parse(_post(appContext, URLs.MY_INFORMATION, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static UserInformation information(AppContext appContext, long uid, long hisuid, String hisname, int pageIndex, int pageSize) throws AppException {
        ...
        try{
            return UserInformation.parse(_post(appContext, URLs.USER_INFORMATION, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result updateRelation(AppContext appContext, long uid, long hisuid, int newrelation) throws AppException {
        ...
        try{
            return Result.parse(_post(appContext, URLs.USER_UPDATERELATION, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result delBlog(AppContext appContext, long uid, long authoruid, int id) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.USERBLOG_DELETE, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result pubPost(AppContext appContext, Post post) throws AppException {
        ...
        params.put("isNoticeMe", String.valueOf(post.getIsNoticeMe()));

        try{
            return http_post(appContext, URLs.POST_PUB, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result delTweet(AppContext appContext, int uid, int tweetid) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.TWEET_DELETE, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result pubMessage(AppContext appContext, long uid, long receiver, String content) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.MESSAGE_PUB, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result delMessage(AppContext appContext, long uid, long friendid) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.MESSAGE_DELETE, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result pubBlogComment(AppContext appContext, int blog, long uid, String content) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.BLOGCOMMENT_PUB, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result delBlogComment(AppContext appContext, long uid, int blogid, int replyid, long authorid, long owneruid) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.BLOGCOMMENT_DELETE, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result pubComment(AppContext appContext, int catalog, int id, long uid, String content, int isPostToMyZone) throws AppException {
        ...
        params.put("uid", uid+"");
        params.put("content", content);
        params.put("isPostToMyZone", String.valueOf(isPostToMyZone));

        try{
            return http_post(appContext, URLs.COMMENT_PUB, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result replyComment(AppContext appContext, int id, int catalog, int replyid, long authorid, long uid, String content) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.COMMENT_REPLY, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result delComment(AppContext appContext, int id, int catalog, int replyid, int authorid) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.COMMENT_DELETE, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result addFavorite(AppContext appContext, long uid, int objid, int type) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.FAVORITE_ADD, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Result delFavorite(AppContext appContext, long uid, int objid, int type) throws AppException {
        ...
        try{
            return http_post(appContext, URLs.FAVORITE_DELETE, params);
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static SoftwareList getSoftwareList(AppContext appContext,final String searchTag,final int pageIndex,final int pageSize) throws AppException {
        ...
        try{
            return SoftwareList.parse(_post(appContext, URLs.SOFTWARE_LIST, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static SoftwareList getSoftwareTagList(AppContext appContext,final int searchTag,final int pageIndex,final int pageSize) throws AppException {
        ...
        try{
            return SoftwareList.parse(_post(appContext, URLs.SOFTWARETAG_LIST, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static Software getSoftwareDetail(AppContext appContext, final String ident) throws AppException {
        ...
        try{
            return Software.parse(_post(appContext, URLs.SOFTWARE_DETAIL, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
    ...
    public static String report(AppContext appContext, Report report) throws AppException {
        ...
        try{
            return StringUtils.toConvertString(_post(appContext, URLs.REPORT, params));
        }catch(Exception e){
            if(e instanceof AppException)
                throw (AppException)e;
            throw AppException.network(e);
