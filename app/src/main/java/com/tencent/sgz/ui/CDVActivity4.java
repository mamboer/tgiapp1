...
public class CDVActivity4 extends Activity implements CordovaInterface {

	private CordovaWebView cordova_webview;
	private String TAG = "CDVActivity4";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.frame_cdv4);
		cordova_webview = (CordovaWebView) findViewById(R.id.cdv4);
		// Config.init(this);
		String url = "4.html";
