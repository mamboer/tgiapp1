...
public class CDVActivity2 extends Activity implements CordovaInterface {

	private CordovaWebView cordova_webview;
	private String TAG = "CDVActivity2";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.frame_cdv2);
		cordova_webview = (CordovaWebView) findViewById(R.id.cdv2);
		// Config.init(this);
		String url = "file:///android_asset/www/2.html";
