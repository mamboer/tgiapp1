...
public class URLs implements Serializable {
	...
	public final static String POST_LIST = URL_API_HOST+"mamboer/n3gz/master/app/src/main/assets/www/data/news_list.xml";//http://www.oschina.net/action/api/post_list?catalog=1&pageIndex=1&pageSize=10
	...
	public final static String UPDATE_VERSION = URL_API_HOST+"mamboer/n3gz/master/app/src/main/assets/data/MobileAppVersion.xml";
		...
		try {
			...
			if(url.getHost().contains(URL_HOST)){
				...
				if(path.contains(URL_WWW_HOST )){
					//新闻  www.3gz.qq.com/news/27259/mobile-internet-market-is-small
					...
					//问答
						...
						//问答-标签  http://www.3gz.qq.com/question/tag/python
						...
						//问答  www.3gz.qq.com/question/12_45738
						else{
