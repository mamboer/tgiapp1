...
public class CDVActivity3 extends Activity implements CordovaInterface {

	private CordovaWebView cordova_webview;
	private String TAG = "CDVActivity3";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.frame_cdv3);
		cordova_webview = (CordovaWebView) findViewById(R.id.cdv3);
		// Config.init(this);
		String url = "3.html";
